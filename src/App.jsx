...
export default function App() {
  ...
  useEffect(() => {
    ...
    document.body.style.background = theme === "dark" ? "#0C0D18" : "#F7F5FF";
  }, [theme]);
  ...
  return (
    <div className={`app-shell theme-${theme}`}>
      <style>{`
        :root { --paper:#F7F5FF; --surface:rgba(255,255,255,.78); --surface-soft:rgba(255,255,255,.56); --surface-elevated:rgba(255,255,255,.9); --ink:#151423; --muted:#6A6878; --line:rgba(21,20,35,.14); --accent:#5B4BFF; --violet:#9B6BFF; --pink:#FF4F87; --lime:#E5FF7A; --cyan:#48D9D0; --on-accent:#FFFFFF; --on-soft:#151423; --shadow:0 20px 55px rgba(45,34,115,.16); --radius:12px; --ease:cubic-bezier(.23,1,.32,1); --font-display:"DM Serif Display", Georgia, serif; --font-sans:"DM Sans", Inter, ui-sans-serif, system-ui, sans-serif; }
        .theme-dark { --paper:#0C0D18; --surface:rgba(24,25,45,.84); --surface-soft:rgba(244,243,255,.08); --surface-elevated:rgba(31,32,57,.92); --ink:#F4F3FF; --muted:#AAA9BC; --line:rgba(244,243,255,.17); --accent:#7C6CFF; --violet:#B89CFF; --pink:#FF719F; --lime:#2D3B36; --cyan:#5FE6DC; --on-accent:#101022; --on-soft:#F4F3FF; --shadow:0 24px 70px rgba(0,0,0,.44); }
        * { box-sizing:border-box; }
        ...
        .theme-dark::before { opacity:.2; background-image:radial-gradient(circle at 15% 10%,rgba(124,108,255,.18),transparent 28%),radial-gradient(circle at 86% 15%,rgba(255,113,159,.13),transparent 26%),linear-gradient(rgba(255,255,255,.04) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.04) 1px,transparent 1px); background-size:auto,auto,44px 44px,44px 44px; }
        ...
        .vengeance-landing { position:relative; min-height:calc(100vh - 72px); overflow:hidden; isolation:isolate; color:var(--landing-fg); background:var(--landing-bg); --landing-bg:#F7F5FF; --landing-fg:#151423; --landing-accent:#FF4F87; --landing-cool:#5B4BFF; --pointer-x:50%; --pointer-y:50%; } .theme-dark .vengeance-landing { --landing-bg:#0C0D18; --landing-fg:#F4F3FF; --landing-accent:#FF719F; --landing-cool:#7C6CFF; }
