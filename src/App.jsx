    ...
    <div className={`app-shell theme-${theme}`}>
      <style>{`
        ...
        * { box-sizing:border-box; }
        ...
        .directory-card-actions { align-items:center; justify-content:flex-end; margin-top:auto; }
