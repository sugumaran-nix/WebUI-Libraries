    ...
    <div className={`app-shell theme-${theme}`}>
      <style>{`
        ...
        * { box-sizing:border-box; }
        ...
        .directory-card-info-row { display:flex; align-items:center; gap:8px; min-width:0; margin-top:13px; }
