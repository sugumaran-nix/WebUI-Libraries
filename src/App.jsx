    ...
    <div className={`app-shell theme-${theme}`}>
      <style>{`
        ...
        * { box-sizing:border-box; }
        ...
        .filter-trigger svg { color:var(--blue); }
        ...
        .quick-access-clear { display:inline-flex; align-items:center; gap:6px; flex:0 0 auto; min-height:32px; padding:0 10px; border:1px solid transparent; border-radius:9px; color:var(--blue); background:transparent; font-size:10px; font-weight:900; cursor:pointer; }
        .quick-access-clear:hover:not(:disabled) { color:var(--ink); background:color-mix(in srgb,var(--blue) 12%,transparent); }
        ...
        .panel-eyebrow, .filter-label { color:var(--blue); font-size:9px; font-weight:900; letter-spacing:.13em; text-transform:uppercase; }
        ...
        .filter-option.selected { color:var(--ink); border-color:color-mix(in srgb,var(--accent) 26%,transparent); background:linear-gradient(90deg,color-mix(in srgb,var(--accent) 14%,transparent),color-mix(in srgb,var(--blue) 9%,transparent)); }
        ...
        .filter-panel-tip svg { flex-shrink:0; color:var(--blue); }
        ...
        .recent-label { flex-shrink:0; color:var(--blue); font-size:9px; font-weight:900; letter-spacing:.11em; text-transform:uppercase; }
        ...
        .resource-preview::after { content:""; position:absolute; top:9px; left:11px; z-index:4; width:34px; height:7px; pointer-events:none; border-radius:999px; background:radial-gradient(circle at 3px 3px,var(--blue) 0 3px,transparent 3.5px),radial-gradient(circle at 17px 3px,var(--cyan) 0 3px,transparent 3.5px),radial-gradient(circle at 31px 3px,var(--accent) 0 3px,transparent 3.5px); }
        ...
        .directory-card-info-row { display:flex; align-items:center; gap:8px; min-width:0; min-height:25px; margin-top:13px; }
        .directory-card-tags { display:flex; flex:1 1 auto; flex-wrap:wrap; gap:5px; min-width:0; margin-top:0; }
        ...
        .directory-card-index { flex:0 0 auto; margin-left:auto; color:var(--muted); font-size:8px; font-weight:900; letter-spacing:.08em; white-space:nowrap; }
        ...
        @media (max-width:640px) { .directory-results-head > div:first-child { width:100%; align-self:stretch; } .directory-main { padding:84px 12px 34px; } .directory-search-strip { padding:12px; border-radius:12px; } .directory-search-strip-copy label { font-size:11px; white-space:normal; } .directory-masthead { grid-template-columns:1fr; gap:20px; padding:24px 18px; border-radius:18px; } .directory-masthead h1 { font-size:clamp(2.8rem,15vw,4.7rem); } .directory-lede { margin-top:15px; font-size:12px; } .directory-masthead-stat { justify-items:start; min-width:0; } .directory-masthead-stat strong { font-size:32px; } .directory-search-field { min-height:54px; } .directory-search-field kbd { display:none; } .directory-filter-rail { margin-bottom:18px; } .directory-rail-intro { display:block; } .directory-rail-intro p:last-child { margin-top:7px; text-align:left; } .directory-filter-list { grid-template-columns:1fr; gap:7px; } .directory-filter-trigger { min-height:54px; } .directory-filter-menu { top:84px; right:12px; left:12px; } .directory-results-head { align-items:flex-start; flex-direction:column; gap:13px; } .directory-results-actions { justify-content:space-between; width:100%; } .directory-result-count { min-height:28px; } .directory-card-grid { grid-template-columns:repeat(2,minmax(0,1fr)); gap:10px; } .directory-card-grid:not(.is-list) .directory-card-body > p { display:none; min-height:0; } .directory-card-grid:not(.is-list) .directory-card-body h3 { margin-top:7px; } .directory-card-grid:not(.is-list) .directory-card-info-row { min-height:23px; margin-top:10px; } .directory-card-grid:not(.is-list) .directory-copy-button { min-width:76px; } .directory-card-grid.is-list { grid-template-columns:1fr; gap:14px; } .directory-preview-frame { aspect-ratio:16/10; } .directory-card-body { padding:15px; } .directory-card-body h3 { font-size:18px; } .directory-card-url { max-width:48%; } .directory-recent-strip { align-items:flex-start; flex-direction:column; gap:12px; padding:16px; } .directory-recent-links { justify-content:flex-start; } .directory-suggestion-trigger { min-height:68px; padding:0 14px; } .directory-suggestion-form { padding:0 14px 14px; } .directory-form-grid { grid-template-columns:1fr; } .directory-form-footer { align-items:stretch; flex-direction:column; } .directory-primary-button { width:100%; } .directory-footer { align-items:flex-start; flex-direction:column; } .directory-recent-head { width:100%; min-width:0; } .directory-recent-links, .directory-recent-empty { width:100%; } .directory-recent-links a { flex:1 1 auto; justify-content:space-between; } }
        ...
        .directory-results-head { align-items:center; padding-bottom:18px; }
        .directory-results-head > div:first-child { flex:1 1 auto; min-width:0; align-self:flex-start; text-align:left; }
        .directory-results-head h2, .directory-results-head p, .directory-results-head .directory-eyebrow { text-align:left; }
        .directory-results-actions { flex:0 0 auto; }
        .directory-result-count { display:inline-flex; align-items:center; min-height:30px; padding:0 8px; border:2px solid var(--ink); border-radius:8px; color:var(--ink); background:var(--surface); font-variant-numeric:tabular-nums; }
        .directory-filter-panel-head { align-items:center; }
        .directory-filter-count { color:#050505; border:2px solid var(--ink); background:var(--accent-fill); }
        .directory-active-filters { margin-top:12px; }
        ...
        .directory-copy-button { min-width:82px; min-height:32px; justify-content:center; padding:0 7px; gap:5px; font-size:8px; }
        ...
        .directory-recent-strip { align-items:flex-start; }
        .directory-recent-head { display:grid; align-content:start; gap:3px; min-width:190px; }
        .directory-recent-head .directory-eyebrow { margin:0; }
        .directory-recent-head strong { margin:0; line-height:1.15; }
        .directory-recent-links, .directory-recent-empty { flex:1; }
        .directory-recent-links { align-items:center; }
        .directory-suggestion-trigger > span, .directory-suggestion-trigger > span > span:last-child { min-width:0; }
        .directory-suggestion-trigger small { line-height:1.35; }
        @media (hover:hover) and (pointer:fine) {
          .directory-resource-card:hover { transform:translate(-2px,-2px); box-shadow:7px 7px 0 var(--neo-shadow-color); }
          .directory-resource-card:hover .directory-preview-link img { transform:scale(1.02); }
        }
        .directory-search-field:focus-within { border-color:var(--ink); background:var(--surface); box-shadow:3px 3px 0 #050505 !important; }
        .directory-search-field input:focus-visible { outline:2px solid var(--ink); outline-offset:2px; }
        .directory-resource-card:focus-within { outline:3px solid var(--focus); outline-offset:3px; }
        .directory-card-body h3 a:focus-visible, .directory-preview-link:focus-visible { outline:3px solid var(--focus); outline-offset:-3px; border-radius:6px; }
        .directory-view-toggle button:active { transform:translate(1px,1px); }
        @media (hover:none) { .directory-resource-card:hover { transform:none; box-shadow:5px 5px 0 var(--neo-shadow-color); } .directory-resource-card:hover .directory-preview-link img { transform:none; } }
        @media (max-width:640px) { .directory-view-toggle button { min-width:54px; min-height:40px; } }
        .theme-dark .directory-card-category { color:color-mix(in srgb,var(--category-accent) 30%,#FFFFFF) !important; }
        .theme-dark .directory-card-body h3 svg, .theme-dark .directory-visit-action { color:color-mix(in srgb,var(--card-accent) 30%,#FFFFFF) !important; }
        .theme-dark .directory-card-body p, .theme-dark .directory-card-url, .theme-dark .directory-card-index { color:#F0F0E8; }
        .theme-dark .directory-card-tags span { color:#050505; border-color:#FFFFFF; background:#FFD400; }
