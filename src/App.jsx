    ...
    <div className={`app-shell theme-${theme}`}>
      <style>{`
        ...
        * { box-sizing:border-box; }
        ...
        .resource-preview { position:relative; aspect-ratio:1200/785; margin:0; overflow:hidden; border-bottom:1px solid var(--line); border-radius:11px 11px 0 0; background:linear-gradient(135deg,var(--surface-soft),var(--surface-elevated)); }
        ...
        @media (max-width:700px) { .resource-grid, .resource-grid.list-view { gap:12px; } .resource-card { border-radius:14px; } .resource-preview { aspect-ratio:1200/785; } .resource-card-copy { padding:12px; } .resource-card h3 { font-size:16px; line-height:1.12; } .resource-card p { min-height:0; font-size:11px; line-height:1.5; } .resource-preview-tools .icon-button { width:40px; height:40px; } .filter-trigger { min-height:40px; } }
