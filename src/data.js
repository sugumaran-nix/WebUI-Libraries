export const CATEGORIES = [
  ...
  { id: "animated",      label: "Animated UI" },
  { id: "shadcn",        label: "shadcn" },
  { id: "tailwind",      label: "Tailwind" },
  { id: "react",         label: "React" },
  { id: "vue-svelte",    label: "Vue and Svelte" },
  { id: "angular",       label: "Angular" },
  { id: "headless",      label: "Headless UI" },
  { id: "css",           label: "CSS and HTML" },
  { id: "collections",   label: "Resource collections" },
  { id: "design-tools",  label: "Design tools" },
  { id: "dev-tools",     label: "Developer tools" },
  { id: "inspiration",   label: "Design references" },
  { id: "icons",         label: "Icons" },
  { id: "illustrations", label: "Illustrations" },
  { id: "typography",    label: "Typography" },
  { id: "color",         label: "Color tools" },
  { id: "mockups",       label: "Mockup tools" },
...
export const SORT_OPTIONS = [
  { id:"featured", label:"Default order" },
...
export const LIBS = [
  ...
  { id:129,name:"Siiimple",              url:"siiimple.com",                        cat:"collections",   desc:"Selected collection of simple, polished, and visually focused websites", added:"2026-08" },
  ...
  { id:137,name:"60fps",                  url:"60fps.design",                        cat:"inspiration",   desc:"60fps is a curated collection of UI/UX animation and interaction design details from the world’s best iOS, and web apps.", added:"2026-08" },
  { id:138,name:"Godly Websites",         url:"godly.website",                       cat:"inspiration",   desc:"The best design inspiration on the Internet.", added:"2026-08" },
  ...
  { id:140,name:"Refero",                 url:"refero.design",                       cat:"inspiration",   desc:"The largest collection of UI/UX references and design inspiration for web and iOS. Explore tens of thousands of screenshots with advanced search capabilities", added:"2026-08" },
  { id:141,name:"Stark",                  url:"getstark.co",                         cat:"design-tools",  desc:"The suite of integrated accessibility tools for your product design and development team • Making the world’s products accessible.", added:"2026-08" },
  ...
  { id:143,name:"Laws of UX",             url:"lawsofux.com",                        cat:"inspiration",   desc:"Laws of UX is a collection of best practices that designers can consider when building user interfaces.", added:"2026-08" },
  { id:144,name:"Growth.Design",          url:"growth.design",                       cat:"inspiration",   desc:"Level up your product skills with bite-sized tips. Learn the growth & design strategies used by the top product companies in the world.", added:"2026-08" },
  { id:145,name:"Nielsen Norman Group",   url:"nngroup.com",                          cat:"inspiration",   desc:"A leader in the user experience field, NN/g conducts groundbreaking research, trains and certifies UX practitioners, and provides UX consulting to clients.", added:"2026-08" },
  { id:146,name:"UXtweak",                url:"uxtweak.com",                         cat:"ux-research",   desc:"User research platform, rated 4.7/5 on G2. All the tools for moderated & unmoderated UX research. Recruit globally with guaranteed quality.", added:"2026-08" },
  { id:147,name:"Maze Guides",            url:"maze.co/guides",                       cat:"ux-research",   desc:"Level up your research expertise with our collection of guides, reports and industry resources.", added:"2026-08" },
  { id:148,name:"Axe DevTools",           url:"deque.com/axe/devtools",               cat:"dev-tools",     desc:"Integrate accessibility testing into your existing automated testing process with Axe DevTools. Toolkits available for web, iOS, and Android.", added:"2026-08" },
  ...
  { id:150,name:"Once UI",                url:"once-ui.com",                          cat:"react",         desc:"An open-source design system for indie creators built with Next.js and Supabase. Ship fully functional apps with copy-paste React code: components, blocks, layouts and pages.", added:"2026-08" },
  ...
  { id:152,name:"v0",                     url:"v0.dev",                               cat:"dev-tools",     desc:"Your collaborative AI assistant to design, iterate, and scale full-stack applications for the web.", added:"2026-08" },

  // Expanded design-resource topics: assets, systems, research, and inspiration
  { id:153,name:"Tabler Icons",            url:"tabler.io/icons",                     cat:"icons",         desc:"Tabler Icons: 6184 free and open source SVG icons. Customizable size, color and stroke. Available for React, SolidJS, Vue, Figma and more for free!", added:"2026-08" },
  { id:154,name:"Phosphor Icons",          url:"phosphoricons.com",                   cat:"icons",         desc:"A flexible icon family for interfaces, diagrams, presentations — whatever, really.", added:"2026-08" },
  { id:155,name:"Iconoir",                 url:"iconoir.com",                         cat:"icons",         desc:"Iconoir is the biggest open source icon library that provides a massive selection of high-quality icons, available for free download. No premium options or email sign-up required, free…", added:"2026-08" },
  { id:156,name:"Fontshare",               url:"fontshare.com",                       cat:"typography",    desc:"Fontshare is a free fonts service from the Indian Type Foundry (ITF), making quality fonts accessible to all.", added:"2026-08" },
  ...
  { id:158,name:"unDraw",                  url:"undraw.co/illustrations",             cat:"illustrations",  desc:"Browse the complete unDraw collection of open-source illustrations. Find and customize the perfect illustration for your next project or website.", added:"2026-08" },
  { id:159,name:"Blush",                   url:"blush.design",                        cat:"illustrations",  desc:"Blush makes it easy to add free illustrations to your designs. Play with fully customizable graphics made by artists across the globe.", added:"2026-08" },
  { id:160,name:"Open Peeps",              url:"openpeeps.com",                       cat:"illustrations",  desc:"Open Peeps is a hand-drawn illustration library to create scenes of people. You can use them in product illustration, marketing, comics, product states, user flows, personas,…", added:"2026-08" },
  { id:161,name:"Open Doodles",            url:"opendoodles.com",                     cat:"illustrations",  desc:"A library of sketchy illustrations of people free for personal and commercial use.", added:"2026-08" },
  ...
  { id:164,name:"UI Goodies",              url:"uigoodies.com",                       cat:"collections",   desc:"A curated directory of the finest design resources, tools, and assets for designers. Browse icons, UI kits, typography, color tools, mockups, illustrations, AI tools, and more, each one…", added:"2026-08" },
  { id:165,name:"Really Good Emails",      url:"reallygoodemails.com",                cat:"email",         desc:"With 19,000+ curated emails and counting, discover the best examples to help build your next campaign. Get inspiration and join millions of marketers.", added:"2026-08" },
  { id:166,name:"Whimsical",               url:"whimsical.com",                       cat:"templates",     desc:"Design and document implementation with diagrams. Shape UI with wireframes. Collaborate with your team and AI.", added:"2026-08" },
  ...
  { id:168,name:"Design Resources",        url:"designresourc.es",                   cat:"collections",   desc:"Design Resources is a design gallery showcasing the best resources, jobs and websites.", added:"2026-08" },
  ...
  { id:170,name:"Hano",                    url:"hano.so",                             cat:"mockups",       desc:"Create 3D device mockups in your browser. Animate scenes, customize screens, and export polished product visuals.", added:"2026-08" },
  { id:171,name:"Superdesigner",           url:"superdesigner.co",                    cat:"color",         desc:"30+ free online design tools — generate backgrounds, gradients, CSS patterns, 3D shapes, color palettes & more. No signup, instant PNG/SVG/CSS export.", added:"2026-08" },
  { id:172,name:"UI Movement",             url:"uimovement.com",                      cat:"inspiration",   desc:"Explore 100,000+ recorded user flows, app screens, and UI patterns from Airbnb, Uber, Netflix & more. Save hours on UX research with Page Flows.", added:"2026-08" },
  ...
  { id:174,name:"DrawKit",                 url:"drawkit.com",                         cat:"illustrations",  desc:"Free and premium vector SVG illustrations for you to use on your next project, no attribution required! Vector illustrations, icons, 3D illustrations, animation, mockups, Figma plugins…", added:"2026-08" },
  ...
  { id:182,name:"Land-book",               url:"land-book.com",                        cat:"inspiration",   desc:"Website design inspiration for creatives, updated daily with website, section, mobile, motion, landing, portfolio, and ecommerce references", added:"2026-08" },
  ...
  { id:184,name:"Curated",                 url:"curated.design",                       cat:"inspiration",   desc:"Live websites and landing pages organized by industry and style, with direct links to the real sites", added:"2026-08" },
