export default function Icon({ name, size = 16, strokeWidth = 1.8, className = "" }) {
  ...
  const paths = {
    ...
    garage: <><path d="M3 20V11a9 9 0 0 1 18 0v9"/><path d="M5 20h14"/><path d="M7 20v-7h10v7"/><path d="M9 16h6"/></>,
    ...
    lightbulb: <><path d="M9 18h6"/><path d="M10 22h4"/><path d="M8.3 14.7A6 6 0 1 1 15.7 14.7c-.9.7-1.3 1.5-1.6 2.3H9.9c-.3-.8-.7-1.6-1.6-2.3Z"/><path d="M12 2v1M4.9 4.9l.7.7M2 12h1M19.1 4.9l-.7.7M21 12h1"/></>,
  };
